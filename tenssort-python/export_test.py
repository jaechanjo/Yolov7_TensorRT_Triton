...
if __name__ == "__main__":
    ...
    # !python ./tensorrt-python/export.py -o ./yolov7-tiny_1.onnx -e ./yolov7-tiny_1-fp16-nms.trt -p fp16 --calib_batch_size=1 --end2end --max_det=100
    # !python ./tensorrt-python/export.py -o ./yolov7-tiny_16.onnx -e ./yolov7-tiny_16-fp16-nms.trt -p fp16 --calib_batch_size=16 --max_det=100 #["fp32", "fp16", "int8"]
    
    parser = argparse.ArgumentParser()
    parser.add_argument("-o", "--onnx", default="./yolov7-tiny_16.onnx", help="The input ONNX model file to load")
    parser.add_argument("-e", "--engine", default="./yolov7-tiny_16-fp16-nms.trt", help="The output path for the TRT engine")
    ...
    parser.add_argument("--calib_batch_size", default=16, type=int,
                        help="The batch size for the calibration process, default: 8") #8
    parser.add_argument("--end2end", default=False, action="store_true",
                        help="export the engine include nms plugin, default: False") #False
